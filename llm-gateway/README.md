...
OpenAI Codex OAuth 호환 연동(비공식 커뮤니티 어댑터, 로컬 선택 기능)입니다. OpenAI의 공식 기능으로 소개하지 않습니다. fixture 데모에는 로그인이나 유료 키가 필요하지 않습니다. 로컬에서 명시적으로 선택한 경우에만 계정 권한과 서비스 약관을 확인하고 사용하십시오. 인증 파일 경로나 토큰 값을 로그·화면·샌드박스에 전달하지 마십시오.
